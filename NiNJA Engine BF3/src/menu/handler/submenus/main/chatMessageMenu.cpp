#include "stdafx.h"
#include "chatMessageMenu.h"
#include "../mainMenu.h"

using namespace ChatMessageMenuVars;
...
void ChatMessageMenu::UpdateOnce() {}

/*Update while submenu is active*/
void ChatMessageMenu::Update() {}

/*Background update*/
void ChatMessageMenu::FeatureUpdate() {}

/*Singleton*/
ChatMessageMenu* _instance;
ChatMessageMenu* ChatMessageMenu::GetInstance() {
	if (_instance == nullptr) {
		_instance = new ChatMessageMenu();
		_instance->Init();
		pSubmenuHandler.AddSubmenu(_instance);
	}
	return _instance;
}
ChatMessageMenu::~ChatMessageMenu() { delete _instance; }