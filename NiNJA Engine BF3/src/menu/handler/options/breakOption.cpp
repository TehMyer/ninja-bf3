...
void BreakOption::Render(int pos) {
	pDrawText.DrawOptionTextBoldCenterAlign(szName, 0, pMenu.iYPositonEditable + (360 - (pRenderer.fBgPosition / 2) + pRenderer.fPositionAnimFix) + 2 + (pos * 22) + 7, 18.f, GColor(255, 255, 255, 255));
}
