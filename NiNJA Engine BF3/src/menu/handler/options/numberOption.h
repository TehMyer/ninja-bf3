...
private:
	...
	bool bIsFloat;
public:
	NumberOption(ScrollOptionType type, const char* name, bool isFloat = false) 
		: Option(name) {
		bIsFloat = isFloat;
		ScrollType = type;
		bCanBeSaved = false;
	...
	NumberOption& addOnUpdate(function<void()> func) {
		FuncOnUpdate = func;
		return *this;
	}
	...
	NumberOption& addOnHover(function<void()> func) {
		FuncOnUpdate = func;
		return *this;
	}
