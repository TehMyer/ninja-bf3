...
void ColorOption::Render(int pos) {
	...
	if (bPreviewBox && pColor) {
		pShapes.RectangleOutlined(640 + (410 / 2) - 20, pMenu.iYPositonEditable + (360 - (pRenderer.fBgPosition / 2) + pRenderer.fPositionAnimFix) + (pos * 22) + 17, 10, 10, 1, *pColor, *pColor, true);
	}
