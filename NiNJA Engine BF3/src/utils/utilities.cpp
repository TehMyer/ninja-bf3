...
Vec3 Utils::MatrixToLeft(D3DXMATRIX m) {
	Vec3 ret;
	ret.x = m.m[0][0];
	ret.y = m.m[0][1];
	ret.z = m.m[0][2];
...
Vec3 Utils::MatrixToUp(D3DXMATRIX m) {
	Vec3 ret;
	ret.x = m.m[1][0];
	ret.y = m.m[1][1];
	ret.z = m.m[1][2];
...
Vec3 Utils::MatrixToForward(D3DXMATRIX m) {
	Vec3 ret;
	ret.x = m.m[2][0];
	ret.y = m.m[2][1];
	ret.z = m.m[2][2];
...
Vec3 Utils::MatrixToTranslation(D3DXMATRIX m) {
	Vec3 ret;
	ret.x = m.m[3][0];
	ret.y = m.m[3][1];
	ret.z = m.m[3][2];
